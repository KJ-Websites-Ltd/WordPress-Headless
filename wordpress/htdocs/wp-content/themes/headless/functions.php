...
//add_filter( 'wp_headless_rest__enable_rest_nonce', '__return_false' );
 ...
 *
 */
//add_filter( 'wp_headless_rest__enable_rest_nonce_generator_endpoint', '__return_false' );
 ...
 *
 */
add_filter( 'wp_headless_rest__enable_jwt', '__return_false' );
